// lab.js - Implementation of the Cows and Bulls game
// Author: Penetha Jayakumar <pejayaku@ucsc.edu>
// Date:10 October 2024

// A pseudo-code for the Cows and Bulls game:
  ...
  // 8. If 4 bulls, the player who guessed correctly wins.
    // 8.1 Generate a prompt to display 'Winner is Player X' and proceed to the step 10. 
  // 9. Otherwise, steps 5-7 are repeated until the word guessed has 4 bulls. 
    // 9.1 If the number of attempts has been reached, generate a prompt 'Player X Lost. No more attempts available. The correct word is XXX' and proceed to step 10.
  // 10. Generate a Prompt with options for a new game or a new word or to end the game.
    // 10.1 If new game is chosen, repeat from step 1.
    // 10.2 If new word is chosen, repeat from step 4.
    // 10.3 If exit is chosen, close the console.
